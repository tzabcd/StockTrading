...
namespace Stock_Trading_UserRegister_Shell
{
    /// <summary>
    /// ManagerAgent 的摘要说明。
    /// </summary>
    ...
    {
        private static string ServiceName = "Stock Trading UserRegister ";

        private static string DisplayName = "Stock Trading UserRegister";

        private static string Description = "模拟炒股用户注册服务";
